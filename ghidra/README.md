...
Historical ignored logs may be unavailable; a 2026-08-17 audit found that many
logs named in manifest citations no longer existed.

Manifest entries that cite an ignored log must record the recipe in the
