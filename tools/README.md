...
| Test s2c 0x018D presentation validation | `python tools\test_s2c_018d_presentation.py` | Twenty-two planted defects covering identity, extents, ownership, RTTI, accessors, marker verdicts, and the separate gate |
