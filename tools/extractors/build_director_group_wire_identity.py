...
ROWS = [
    (
        ...
        "BCS-Y-0563",
        "0x005763B0",
        ["BCS-Y-0873", "BCS-Y-1795"],
        "0x006C9910 -> 0x006C96B0",
        0x90,
    ),
    ...
    (
        ...
        "0x00576390",
        ["BCS-Y-0885"],
        "0x006C8340 -> 0x006C6B20 / 0x006C5460",
        0x40,
    ),
    (
        "0x018B",
...
def build(decomp: Path) -> dict:
    ...
    header_text = (
        required["group_header"].read_text(encoding="utf-8", errors="replace").lower()
    )
    ...
    members_text = (
        required["group_members_x08"]
        .read_text(encoding="utf-8", errors="replace")
        .lower()
    )
    for expected in (
        "movsx eax,byte ptr [esi + 0x190]",
        "lea edx,[esi + 0x10]",
        "call 0x006c1040",
    ):
    ...
    return {
        ...
        "inputs": {
            "party_subsystem": {
                "path": "manifests/party_subsystem.json",
                "sha256": digest(party),
            },
            **{
                key: {
                    "path": f"xivl-decomp:asm/ffxivgame/{path.name}",
                    "sha256": digest(path),
                }
        ...
        "layouts": {
            "0x017C": {
                "groupTypeCandidate": {"offset": 0x30, "width": 4},
            ...
            "0x017F": {
                ...
                "recordStride": 0x30,
                "actorIdOffset": 0,
                "unresolvedFieldOffset": 8,
                "memberCountOffset": 0x190,
            },
            "0x0183": {
                "recordsOffset": 0x10,
                "recordCount": 8,
