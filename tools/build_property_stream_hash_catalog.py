...
def build(accounting_path: Path, source_commit: str) -> dict:
    ...
    catalog["provenance"]["candidateBoundary"] = (
        "The 263 candidate names predate this campaign in the canonical catalog. "
        "This pass re-verifies every exact hash and does not promote similarity or contextual guesses."
    )
